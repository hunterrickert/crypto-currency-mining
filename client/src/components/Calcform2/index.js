        ...
        <Row>
          <Col xs="6" style={{ marginTop: "15px" }}>
            <InputGroup>
              ...
              <UncontrolledTooltip placement="auto" target="costexplain1">
          ...
          <Col xs="6" style={{ marginTop: "15px" }}>
            <InputGroup>
              ...
              <UncontrolledTooltip placement="auto" target="wattsexplain1">
          ...
          <Col xs="6" style={{ marginTop: "15px" }}>
            <InputGroup>
              ...
              <UncontrolledTooltip placement="auto" target="hashexplain1">
        ...
        <Row style={{ marginTop: "10px" }}>
          <Col xs="6" style={{ marginTop: "15px" }}>
            <InputGroup>
              <InputGroupAddon addonType="prepend">
                <InputGroupText style={{ fontSize: "12px" }}>
                  <span href="#" id="minedeth">
                    Mined ETH
                  </span>
                </InputGroupText>
              </InputGroupAddon>
              <UncontrolledTooltip placement="auto" target="minedeth">
                Mine ETH refers to the amount of Ethereum mined in a month.
              </UncontrolledTooltip>
              <Input
